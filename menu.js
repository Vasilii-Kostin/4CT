...
document.addEventListener('DOMContentLoaded', function() {
    ...
    `;
    footer.innerHTML = `
        <p>Проект 4CT — конструктивное доказательство теоремы о четырёх красках и оптимизация раскраски. Приветствую всех любителей математики..., и, конечно, профессионалов тоже!</p>
